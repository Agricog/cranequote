        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-3xl">
            ...
            <p className="text-xl md:text-2xl text-primary-100 mb-8">
              Free instant estimates for crane hire costs. Compare prices, understand your options, 
              and get quotes from local crane companies.
            </p>
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16" id="calculators">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-600 max-w-2xl mx-auto">
            Professional tools to help you estimate costs, choose the right crane, 
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-gray-600">
              Get crane hire estimates in under 2 minutes
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="text-center">
              ...
              <p className="text-gray-600">
                Tell us about your lift - load weight, location, duration, and any special requirements.
              </p>
            </div>
            <div className="text-center">
              <div className="w-16 h-16 bg-primary-500 rounded-2xl flex items-center justify-center mx-auto mb-4">
              ...
              <p className="text-gray-600">
                See recommended crane sizes and cost ranges based on current UK market rates.
              </p>
            </div>
            <div className="text-center">
              <div className="w-16 h-16 bg-primary-500 rounded-2xl flex items-center justify-center mx-auto mb-4">
              ...
              <p className="text-gray-600">
                Connect with local crane companies to get formal quotes for your specific project.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          <div>
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-6">
              Covering All UK Regions
            </h2>
            <p className="text-lg text-gray-600 mb-6">
              Our calculators include regional pricing adjustments to give you accurate estimates 
